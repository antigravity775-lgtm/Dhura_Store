      ...
      <Layout>
        ...
        <div className="max-w-2xl mx-auto px-4 py-24 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              to="/my-orders"
              className="px-6 py-3 bg-gold-600 text-white font-bold rounded-xl hover:bg-gold-500 transition-colors"
            >
              متابعة طلباتي
            </Link>
            {storeInfo && (
    ...
    return (
      <Layout>
        ...
        <div className="max-w-2xl mx-auto px-4 py-24 text-center">
          ...
          <Link
            to="/"
            className="inline-flex items-center gap-2 px-6 py-3 bg-gold-600 text-white font-bold rounded-xl hover:bg-gold-500 transition-colors"
          >
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {item.quantity >= (item.stockQuantity || 9999) && (
                      <div className="flex items-center gap-1 mt-1.5 text-gold-600 dark:text-gold-400">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm sticky top-24">
              ...
              {!showCheckout ? (
                <button
                  ...
                  className="w-full py-3.5 bg-gold-600 text-white font-bold rounded-xl hover:bg-gold-500 transition-all shadow-lg shadow-gold-600/20 active:scale-[0.98]"
                >
                  إتمام الطلب
                </button>
              ) : (
