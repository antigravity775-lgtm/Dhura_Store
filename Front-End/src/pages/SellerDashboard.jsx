    ...
    <div className="min-h-screen bg-bone dark:bg-slate-950 font-sans" dir="rtl">
      ...
      <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                {user?.isVerified && (
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 text-blue-600 dark:text-blue-400 text-[10px] font-bold rounded-lg">
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/profile"
              className="text-sm text-slate-400 hover:text-gold-600 dark:hover:text-gold-400 font-medium transition-colors hidden sm:block"
            >
            ...
            <Link
              to="/"
              className="text-sm text-slate-500 dark:text-slate-400 hover:text-gold-600 dark:hover:text-gold-400 font-medium transition-colors flex items-center gap-1"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-5 mb-8">
          {[
            { label: 'إجمالي المنتجات', value: products.length, icon: Package, color: 'bg-gold-50 dark:bg-gold-900/30 text-gold-600 dark:text-gold-400 border-gold-100 dark:border-gold-800' },
            ...
            { label: 'المبيعات', value: sales.length, icon: DollarSign, color: 'bg-gold-50 dark:bg-gold-900/30 text-gold-600 dark:text-gold-400 border-gold-100 dark:border-gold-800' },
          ].map(stat => (
        ...
        <AnimatePresence>
          {error && (
            <motion.div
              ...
              exit={{ opacity: 0 }}
              className="mb-4 flex items-center justify-between bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 text-sm px-4 py-3 rounded-xl"
            >
          ...
          {success && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0 }}
              className="mb-4 flex items-center justify-between bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-green-600 dark:text-green-400 text-sm px-4 py-3 rounded-xl"
            >
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
              ...
              <div className="flex gap-3 w-full sm:w-auto">
                <select
                  ...
                  className="px-4 py-2.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-gold-500/50 text-slate-700 dark:text-slate-200 flex-1 sm:flex-none"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-5 py-2.5 bg-gold-600 text-white text-sm font-bold rounded-xl hover:bg-gold-500 transition-all shadow-lg shadow-gold-600/20 active:scale-[0.98] flex-1 sm:flex-none"
                >
            ...
            {loading ? (
              ...
              <div className="text-center py-20 bg-white dark:bg-slate-900 rounded-2xl border border-dashed border-slate-300 dark:border-slate-700">
                ...
                <button
                  ...
                  className="px-6 py-2.5 bg-gold-600 text-white font-bold rounded-xl hover:bg-gold-500"
                >
                  إضافة منتج
                </button>
              </div>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-2 mt-1.5">
                        ...
                        <span className={`text-[10px] font-bold px-2 py-0.5 rounded-md ${
                          product.isHidden ? 'bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400' : 'bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-400'
                        }`}>
                    ...
                    <div className="flex items-center gap-1 flex-shrink-0">
                      ...
                      <button
                        ...
                        className="p-2 text-slate-300 dark:text-slate-500 hover:text-gold-600 dark:hover:text-gold-400 hover:bg-gold-50 dark:hover:bg-gold-900/30 rounded-xl transition-all"
                        title="تعديل المنتج"
                      >
                      ...
                      <button
                        ...
                        className={`p-2 rounded-xl transition-all disabled:opacity-50 ${
                          product.isHidden
                            ...
                            : 'text-gold-400 hover:text-gold-600 hover:bg-gold-50 dark:hover:bg-gold-900/30'
                        }`}
                      ...
                      <button
                        ...
                        className="p-2 text-slate-300 dark:text-slate-500 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-xl transition-all"
                        title="حذف"
                      >
                ...
                {sales.map(order => {
                  ...
                  <div key={order.id} className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 p-5 hover:shadow-md transition-shadow">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-lg font-extrabold text-gold-600 dark:text-gold-400">
