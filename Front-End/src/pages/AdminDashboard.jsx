...
const AdminDashboard = () => {
  ...
  const {
    ...
    isAuth && activeTab === "dashboard" ? "adminDashboard" : null,
  ...
  const {
    ...
    isAuth && activeTab === "users" ? "adminUsers" : null,
    api.getAdminUsers,
  );
  ...
  const {
    ...
    isAuth && activeTab === "products" ? "adminProducts" : null,
  ...
  const {
    ...
    isAuth && activeTab === "categories" ? "adminCategories" : null,
    api.getCategories,
  );
  ...
  const {
    ...
    isAuth && activeTab === "rates" ? "adminRates" : null,
  ...
  useEffect(() => {
    if (ratesData)
      setRates({
        USD_to_YER_Sanaa:
          ratesData.usD_to_YER_Sanaa ?? ratesData.USD_to_YER_Sanaa ?? 0,
        USD_to_YER_Aden:
          ratesData.usD_to_YER_Aden ?? ratesData.USD_to_YER_Aden ?? 0,
      });
  }, [ratesData]);
  ...
  const {
    ...
    isAuth && activeTab === "storeInfo" ? "adminStoreInfo" : null,
    api.getStoreInfo,
  );
  ...
  const orderStatusBadge = (status) => {
    const cfg = {
      ...
      Shipped: {
        label: "تم الشحن",
        color:
          "bg-gold-100 text-gold-700 border-gold-200 dark:bg-gold-900/30 dark:text-gold-400 dark:border-gold-800",
        Icon: Truck,
      },
      Delivered: {
        label: "تم التوصيل",
    ...
    return (
      <span
        className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold border ${c.color}`}
      >
  ...
  const getRoleBadge = (role) => {
    ...
    return (
      <span
        className={`text-[10px] font-bold px-2 py-0.5 rounded-md border ${styles[role] || styles.Buyer}`}
      >
        {labels[role] || role}
      </span>
    );
      ...
      <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row gap-3 sm:items-center justify-between h-16">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-extrabold text-slate-900 dark:text-white text-lg leading-none">
                لوحة المسؤول
              </h1>
              <p className="text-xs text-slate-400 mt-0.5">
                مرحباً، {user?.fullName || "مسؤول"}
              </p>
            </div>
          </div>
          <Link
            to="/"
            className="text-sm text-slate-500 hover:text-gold-600 font-medium transition-colors flex items-center gap-1"
          >
          ...
          {tabItems.map((tab) => (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-semibold transition-all whitespace-nowrap ${
                activeTab === tab.id
                  ? "bg-white dark:bg-slate-700 text-gold-700 dark:text-gold-300 shadow-sm"
                ...
                {[
                  {
                    ...
                    icon: Users,
                    color:
                      "bg-gold-50 dark:bg-gold-900/30 text-gold-600 dark:text-gold-400 border-gold-100 dark:border-gold-800/50",
                  },
                  {
                        ...
                        <div className="p-5">
                          ...
                          <div className="flex flex-wrap gap-4 text-xs text-slate-500 dark:text-slate-400 mb-4">
                            ...
                            <span className="font-bold text-gold-600 dark:text-gold-400">
                              ...
                              {api.getCurrencySymbol(displayCurrency) || "ريال"}
                            </span>
                          </div>
                          ...
                          <div className="flex flex-wrap items-center gap-2 pt-3 border-t border-slate-100 dark:border-slate-800">
                            ...
                            <button
                              ...
                              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-slate-500 dark:text-slate-400 hover:text-gold-600 dark:hover:text-gold-400 bg-bone dark:bg-slate-800 hover:bg-gold-50 dark:hover:bg-gold-900/30 rounded-lg transition-all"
                            >
                            ...
                            {order.status === "Confirmed" && (
                              <>
                                <button
                                  ...
                                  className="flex items-center gap-1.5 px-4 py-2 text-xs font-bold text-white bg-gold-600 hover:bg-gold-500 rounded-xl transition-all shadow-sm shadow-gold-600/20 active:scale-[0.97]"
                                >
                                    ...
                                    <div className="w-10 h-10 rounded-lg overflow-hidden bg-slate-200 dark:bg-slate-700 flex-shrink-0 border border-slate-200 dark:border-slate-600">
                                      <img
                                        src={
                                          ...
                                          "https://images.unsplash.com/photo-1560472355-536de3962603?w=100&q=60"
                                        }
                    ...
                    <motion.div
                      ...
                      className={`bg-white dark:bg-slate-900 rounded-2xl border dark:border-slate-800 p-4 sm:p-5 flex flex-col md:flex-row gap-4 md:items-center transition-all ${
                        u.isBlocked
                          ...
                          : "border-slate-200 hover:shadow-md dark:hover:shadow-slate-800/50"
                      }`}
                    >
                      {/* User Info */}
                      <div className="flex-1 min-w-0">
                        ...
                        <button
                          ...
                          className={`p-2 rounded-xl transition-all text-sm ${
                            u.isBlocked
                              ...
                              : "text-gold-500 hover:bg-gold-50 hover:text-gold-700"
                          }`}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center mb-6">
              ...
              <div className="flex gap-3 w-full sm:w-auto">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-2.5 bg-gold-600 text-white text-sm font-bold rounded-xl hover:bg-gold-500 transition-all shadow-lg shadow-gold-600/20 active:scale-[0.98]"
                >
                    ...
                    >
                      <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl overflow-hidden bg-slate-100 dark:bg-slate-800 flex-shrink-0 border border-slate-200 dark:border-slate-700">
                        <img
                          src={
                            ...
                            "https://images.unsplash.com/photo-1560472355-536de3962603?w=200&q=60"
                          }
                          alt={product.title}
                          className="w-full h-full object-cover"
                        />
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          {product.isPromoted && (
                            <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-gradient-to-r from-gold-500 to-purple-500 text-white text-[10px] font-bold rounded-md shadow-sm">
                              ⭐ مُروَّج
                            </span>
                          )}
                        </div>
                        <div className="flex flex-wrap items-center gap-2 mt-2">
                          {product.discountPrice ? (
                            <>
                              <span className="text-slate-400 line-through text-xs">
                                ...
                                {api.CurrencySymbol[product.currency] || "ريال"}
                              </span>
                          ...
                          {product.promotionLabel && (
                            <span className="text-[10px] font-bold px-2 py-0.5 rounded-md bg-gold-50 dark:bg-gold-900/30 text-gold-600 dark:text-gold-400 border border-gold-100 dark:border-gold-800">
                              {product.promotionLabel}
                            </span>
                          )}
                      ...
                      <div className="flex items-center gap-1 flex-shrink-0 w-full sm:w-auto justify-end sm:justify-start border-t sm:border-0 border-slate-100 dark:border-slate-800 pt-3 sm:pt-0 mt-2 sm:mt-0">
                        <button
                          ...
                          className="p-2.5 text-slate-300 hover:text-gold-600 hover:bg-gold-50 rounded-xl transition-all"
                          title="تعديل المنتج"
                        >
                    ...
                    <div className="p-5 space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2.5 border border-slate-200 dark:border-slate-600 rounded-xl text-sm bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-gold-500/50 focus:border-gold-400"
                          placeholder="مثال: عسل بلدي"
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1.5">
                          أيقونة التصنيف (اختياري)
                        </label>
                        ...
                        <input
                          ...
                          onChange={async (e) => {
                            ...
                            try {
                              ...
                              setError(
                                "فشل رفع الأيقونة: " + (err.message || ""),
                              );
                            }
                          }}
                          className="w-full px-4 py-2.5 border border-slate-200 dark:border-slate-600 rounded-xl text-sm bg-white dark:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-gold-500/50 focus:border-gold-400 file:mr-4 file:py-1 file:px-3 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-gold-50 file:text-gold-700 hover:file:bg-gold-100"
                        />
                      </div>
                      <div className="flex gap-3 pt-2">
                        <button
                          onClick={handleSaveCategory}
                          className="flex-1 flex items-center justify-center gap-2 px-5 py-2.5 bg-gold-600 text-white text-sm font-bold rounded-xl hover:bg-gold-500 transition-all"
                        >
                    ...
                    >
                      <div className="flex items-center gap-3">
                        {cat.iconUrl ? (
                          ...
                          <div className="w-10 h-10 rounded-xl bg-gold-50 dark:bg-gold-900/30 flex items-center justify-center">
                            <Tag className="w-5 h-5 text-gold-400 dark:text-gold-400" />
                          </div>
                        )}
                      ...
                      <div className="flex flex-wrap gap-1">
                        <button
                          ...
                          className="p-2 text-slate-300 hover:text-gold-600 hover:bg-gold-50 rounded-xl transition-all"
                          title="تعديل"
                        >
          ...
          <div>
            ...
            {ratesLoading ? (
              ...
              <div className="max-w-lg">
                ...
                >
                  {/* Header Alert */}
                  <div className="flex items-center gap-3 mb-6 p-4 bg-gold-50 dark:bg-gold-900/20 border border-gold-200 dark:border-gold-800/50 rounded-2xl">
                    <DollarSign className="w-6 h-6 text-gold-600 flex-shrink-0" />
                    <div>
                      <p className="font-bold text-gold-800 dark:text-gold-400 text-sm">
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full px-4 py-3 border border-slate-200 dark:border-slate-600 rounded-xl text-lg font-bold text-slate-900 dark:text-slate-100 bg-white dark:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-gold-500/50 focus:border-gold-400"
                          dir="ltr"
                          min="1"
                          step="0.01"
                        />
                      ...
                      <p className="text-xs text-slate-400 mt-1">
                        1 دولار ={" "}
                        {rates.USD_to_YER_Sanaa?.toLocaleString("en-US")} ريال
                        صنعاء
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400 mt-1">
                        1 دولار ={" "}
                        {rates.USD_to_YER_Aden?.toLocaleString("en-US")} ريال
                        عدن
                      </p>
                    </div>
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-6 py-3.5 bg-gradient-to-r from-gold-600 to-purple-600 text-white font-bold rounded-xl hover:from-gold-500 hover:to-purple-500 transition-all shadow-lg shadow-gold-600/20 disabled:opacity-60 active:scale-[0.98]"
                    >
                      {ratesSaving ? (
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:items-center justify-between bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">
                  تحديث معلومات "من نحن" وروابط التواصل الاجتماعي التي تظهر في
                  الفوتر.
                </p>
              </div>
            </div>
              ...
              <div className="p-6 space-y-6 max-w-2xl">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-bone dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-gold-500/50 min-h-[120px] resize-y"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-bone dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-gold-500/50"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-bone dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-gold-500/50 text-left"
                      dir="ltr"
