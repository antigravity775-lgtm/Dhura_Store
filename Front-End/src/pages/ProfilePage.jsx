      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 md:py-12 mb-12">
        ...
        <div className="mb-8">
          <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight flex items-center gap-3">
            <div className="p-2.5 bg-gold-100 dark:bg-gold-900/40 rounded-2xl">
              <User className="w-7 h-7 text-gold-600 dark:text-gold-400" />
            </div>
            الملف الشخصي
          </h1>
          ...
          <form onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pr-12 pl-4 py-3.5 rounded-xl bg-bone dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-slate-100 text-sm focus:outline-none focus:ring-2 focus:ring-gold-500/40 focus:border-gold-400 focus:bg-white dark:focus:bg-slate-700 transition-all"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="w-full pr-12 pl-4 py-3.5 rounded-xl bg-bone dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-slate-100 text-sm focus:outline-none focus:ring-2 focus:ring-gold-500/40 focus:border-gold-400 focus:bg-white dark:focus:bg-slate-700 transition-all appearance-none cursor-pointer"
                  >
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className={`flex items-center justify-center gap-2.5 py-4 rounded-xl border-2 text-sm font-bold transition-all ${
                      preferredCurrency === 'YER'
                        ? 'bg-gold-50 dark:bg-gold-900/30 border-gold-500 text-gold-700 dark:text-gold-300 shadow-sm'
                  ...
                  >
                    ...
                    ريال يمني
                    {preferredCurrency === 'YER' && <Check className="w-4 h-4 text-gold-600" />}
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    ...
                    دولار أمريكي
                    {preferredCurrency === 'USD' && <Check className="w-4 h-4 text-gold-600" />}
                  </button>
                </div>
            ...
            <div className="p-6 sm:p-8">
              ...
              <button
                type="submit"
                disabled={saving}
                className="w-full flex items-center justify-center gap-2.5 py-4 bg-gold-600 text-white rounded-xl font-bold text-base hover:bg-gold-500 focus:outline-none focus:ring-4 focus:ring-gold-500/30 transition-all shadow-lg shadow-gold-600/15 disabled:opacity-70 disabled:cursor-not-allowed active:scale-[0.98]"
              >
                {saving ? (
                  <>
