        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-between items-start sm:items-center mb-3">
          <div className="relative w-full sm:w-96">
            ...
            <input
              ...
              className="w-full pl-3 pr-9 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg text-sm focus:ring-2 focus:ring-gold-500/50 outline-none transition-shadow"
            />
          </div>
          <button 
            onClick={() => openEditProductModal(null)}
            className="flex-shrink-0 w-full sm:w-auto flex items-center justify-center gap-1.5 px-4 py-2 text-sm font-bold text-white bg-gold-600 hover:bg-gold-500 rounded-lg transition-colors shadow-sm"
          >
        ...
        {selectedIds.size > 0 && (
          ...
          >
            <div className="flex items-center gap-2 text-white px-2">
              <div className="bg-gold-500 text-white text-xs font-bold w-6 h-6 rounded-full flex items-center justify-center">
                {selectedIds.size}
              </div>
      ...
      <div className="flex-1">
        ...
        <div className="hidden sm:flex items-center px-4 py-3 bg-slate-100 dark:bg-slate-800/50 rounded-t-xl border-b border-slate-200 dark:border-slate-800 mb-2">
          <div className="w-10 flex items-center justify-center">
            <button onClick={selectAll} className="text-slate-400 hover:text-gold-600 transition-colors">
              ...
              return (
                <motion.div 
                  ...
                  className={`flex flex-col sm:flex-row sm:items-center p-3 sm:px-4 sm:py-2.5 bg-white dark:bg-slate-900 border rounded-xl sm:rounded-lg transition-all ${
                    isSelected ? 'border-gold-400 bg-gold-50/30 dark:border-gold-500/50 dark:bg-gold-900/10' : 'border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700'
                  }`}
                >
                  {/* Left Section: Checkbox + Image + Title */}
                  <div className="flex items-center gap-3 flex-1 mb-3 sm:mb-0">
                    <button onClick={() => toggleSelection(p.id)} className="flex-shrink-0 text-slate-400 hover:text-gold-600 transition-colors">
                    ...
                    <div className="flex flex-col min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        ...
                        {p.isPromoted && <span className="text-[10px] text-gold-600 font-bold">⭐ مميز</span>}
                      </div>
                    </div>
                  </div>
