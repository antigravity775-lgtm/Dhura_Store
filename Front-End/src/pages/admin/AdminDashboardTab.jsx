...
const AdminDashboardTab = ({ stats, statsLoading, orders }) => {
  ...
  const statCards = [
    { label: 'إجمالي المستخدمين', value: stats.totalUsers, icon: Users, color: 'bg-gold-50 dark:bg-gold-900/30 text-gold-600 dark:text-gold-400 border-gold-100 dark:border-gold-800/50' },
    ...
    { label: 'إجمالي الطلبات', value: stats.totalOrders, icon: ShoppingCart, color: 'bg-gold-50 dark:bg-gold-900/30 text-gold-600 dark:text-gold-400 border-gold-100 dark:border-gold-800/50' },
