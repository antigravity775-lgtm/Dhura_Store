          ...
          return (
            ...
            >
              ...
              <div className="p-3">
                ...
                <p className="text-xs font-extrabold text-gold-600 dark:text-gold-400 mb-2">
                  {formatPrice(p.discountPrice ? Number(p.discountPrice) : p.price, p.currency)}
                </p>
                <button
                  onClick={(e) => handleAdd(e, p)}
                  className="w-full flex items-center justify-center gap-1 py-1.5 bg-gold-50 dark:bg-gold-900/30 text-gold-700 dark:text-gold-300 rounded-xl text-[11px] font-bold hover:bg-gold-100 dark:hover:bg-gold-900/50 transition-colors"
                >
