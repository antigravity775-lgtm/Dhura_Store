      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 relative">
            ...
            >
              <div className="relative w-10 h-10 md:w-11 md:h-11 rounded-full bg-white flex items-center justify-center p-0 overflow-hidden shadow-md ring-1 ring-gold-200/60">
                <img
                  src={logo}
                  alt="شعار GISAAH قصة"
                  width="44"
              ...
              <span className="font-extrabold text-xl md:text-2xl tracking-tight text-slate-900 dark:text-gold-100 drop-shadow-sm font-display">
                GISAAH
              </span>
            </Link>
