    ...
    <section className="mb-8 sm:mb-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
        ...
        <motion.button
          ...
          className="group relative overflow-hidden rounded-2xl p-5 sm:p-6 bg-gradient-to-br from-gold-500 via-gold-600 to-gold-700 text-white shadow-lg shadow-gold-500/20 hover:shadow-xl hover:shadow-gold-500/30 transition-shadow duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-gold-400 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gold-950 text-right"
        >
          ...
          <div className="relative z-10 flex items-center justify-between">
            <div className="flex flex-col">
              ...
              <span className="text-xs sm:text-sm text-gold-200/80 font-medium">
